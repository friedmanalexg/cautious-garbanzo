...
pile_of_dice = input("How many dice should we roll?")
print("Okay, we'll roll ",pile_of_dice," dice.")
#now we find out how many sides are on each die by asking the user
dice_sides = input("How many sides on each dice?")
print("Okay, we're going to roll D",dice_sides,"s.")
